...
import tacobe.domain.Ingredient.Type;
import tacobe.domain.Taco;
import tacobe.domain.User;
import tacobe.repository.IngredientRepository;
import tacobe.repository.TacoRepository;
  ...
  public CommandLineRunner dataLoader(IngredientRepository repo,
    ...
    return new CommandLineRunner() {
      ...
      public void run(String... args) throws Exception {
		...
		userRepo.save(new User("taco@example.com", encoder.encode("password"), "Taco User",
				"123 North Street", "Cross Roads", "TX", "76227", "111-222-5678"));
